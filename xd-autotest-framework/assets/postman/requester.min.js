...
window.requestFileSystem = window.requestFileSystem || window.webkitRequestFileSystem,
  ...
  pm.collections = {
    ...
    addCollectionListeners: function() {
      $("#collection-items").on("mouseenter", ".sidebar-collection .sidebar-collection-head",
        function() {
          var e = jQuery(".collection-head-actions", this);
          e.css("display", "block")
        }),
        $("#collection-items").on("mouseleave", ".sidebar-collection .sidebar-collection-head",
          function() {
            var e = jQuery(".collection-head-actions", this);
            e.css("display", "none")
          }),
        $("#collection-items").on("click", ".sidebar-collection-head-name",
          function() {
            var e = $(this).attr("data-id");
            pm.collections.toggleRequestList(e)
          }),
        $("#collection-items").on("click", ".collection-head-actions .label",
          function() {
            var e = $(this).parent().parent().parent().attr("data-id");
            pm.collections.toggleRequestList(e)
          }),
        $("#collection-items").on("click", ".request-actions-delete",
          function() {
            var e = $(this).attr("data-id");
            pm.collections.deleteCollectionRequest(e)
          }),
        $("#collection-items").on("click", ".request-actions-load",
          function() {
            var e = $(this).attr("data-id");
            pm.collections.getCollectionRequest(e)
          }),
        $("#collection-items").on("click", ".request-actions-edit",
          function() {
            var e = $(this).attr("data-id");
            $("#form-edit-collection-request .collection-request-id").val(e),
              pm.indexedDB.getCollectionRequest(e,
                function(e) {
        ...
        $("#collection-items").on("click", ".collection-actions-edit",
          function() {
            var e = $(this).attr("data-id"),
        ...
        $("#collection-items").on("click", ".collection-actions-delete",
          function() {
            var e = $(this).attr("data-id"),
              t = $(this).attr("data-name");
        ...
        $("#modal-delete-collection-yes").on("click",
          function() {
            var e = $(this).attr("data-id");
            pm.collections.deleteCollection(e)
          }),
        $("#import-collection-url-submit").on("click",
          function() {
            var e = $("#import-collection-url-input").val();
            pm.collections.importCollectionFromUrl(e)
          }),
        $("#collection-items").on("click", ".collection-actions-download",
          function() {
            var e = $(this).attr("data-id");
        ...
        $("#share-collection-get-link").on("click",
          function() {
            var e = $(this).attr("data-collection-id");
            pm.collections.uploadCollection(e,
              function(e) {
                $("#share-collection-link").css("display", "block"),
                  $("#share-collection-link").html(e)
              })
          }),
        $("#share-collection-download").on("click",
          function() {
            var e = $(this).attr("data-collection-id");
      ...
      e.addEventListener("dragover",
        ...
        e.addEventListener("drop",
          ...
          !1),
        $("#collection-files-input").on("change",
          function(e) {
    ...
    saveCollection: function(e) {
      pm.indexedDB.getCollection(e,
        function(e) {
          var t = e;
          pm.indexedDB.getAllRequestsInCollection(t,
            function(e, t) {
              e.requests = t;
              var n = e.name + ".json",
                r = "application/json",
                i = JSON.stringify(e);
              pm.filesystem.saveAndOpenFile(n, i, r,
                function() {})
            })
        })
    },
    uploadCollection: function(e, t) {
      pm.indexedDB.getCollection(e,
        function(e) {
          pm.indexedDB.getAllRequestsInCollection(e,
            function(e, n) {
              e.requests = n;
              var r = e.name + ".json",
                i = "application/json",
              ...
              pm.indexedDB.addCollection(n,
                function(e) {
                  ...
                  for (var i = 0; i < n.requests.length; i++) {
                    ...
                    s.collectionId = n.id,
                      s.id = guid(),
                      pm.indexedDB.addCollectionRequest(s,
                        function(e) {}),
                      r.push(s)
                  }
                  n.requests = r,
    ...
    openCollection: function(e) {
      ...
      $(t).css("display") === "none" && $(t).slideDown(100,
        function() {
    ...
    addCollection: function() {
      var e = $("#new-collection-blank").val(),
        t = new Collection;
      e && (t.id = guid(), t.name = e, pm.indexedDB.addCollection(t,
        function(e) {
    ...
    addRequestToCollection: function() {
      ...
      o.id = guid(),
        ...
        t ? (s.id = guid(), s.name = t, pm.indexedDB.addCollection(s,
          function(e) {
            $("#sidebar-section-collections .empty-message").css("display", "none"),
              ...
              pm.layout.refreshScrollPanes(),
              pm.indexedDB.addCollectionRequest(o,
                function(e) {
          ...
          })) : (s.id = e, o.collectionId = s.id, pm.indexedDB.addCollectionRequest(o,
          function(e) {
            var t = "#collection-requests-" + e.collectionId;
            pm.urlCache.addUrl(e.url),
            typeof e.name == "undefined" && (e.name = e.url),
    ...
    getAllCollections: function() {
      $("#collection-items").html(""),
        ...
        pm.indexedDB.getCollections(function(e) {
          ...
          else for (var n = 0; n < t; n++) {
            var r = e[n];
            pm.indexedDB.getAllRequestsInCollection(r,
              function(e, t) {
                e.requests = t,
                  console.log(e),
                  pm.collections.render(e)
          ...
          console.log(r),
            ...
            $(i).sortable({
              update: function(e, t) {
                ...
                pm.indexedDB.getCollection(i,
                  function(e) {
                    e.order = u,
                      pm.indexedDB.updateCollection(e,
                        function(e) {})
                  })
              }
            })
    ...
    saveResponseAsExample: function(e, t) {
      pm.indexedDB.getCollectionRequest(e,
        function(e) {
          e.exampleResponse = t,
            console.log(e),
            pm.indexedDB.updateCollectionRequest(e,
              function(e) {
                console.log(e)
              })
        })
  ...
  pm.editor = {
    ...
    toggleLineWrapping: function() {
      ...
      e === !0 ? ($("#response-body-line-wrapping").removeClass("active"), e = !1, pm.editor.codeMirror.setOption("lineWrapping", !1)) : ($("#response-body-line-wrapping").addClass("active"), e = !0, pm.editor.codeMirror.setOption("lineWrapping", !0)),
  ...
  pm.envManager = {
    ...
    init: function() {
      pm.envManager.initGlobals(),
        ...
        $("#environments-list").on("click", ".environment-action-delete",
          function() {
            var e = $(this).attr("data-id");
            $('a[rel="tooltip"]').tooltip("hide"),
              pm.envManager.deleteEnvironment(e)
          }),
        $("#environments-list").on("click", ".environment-action-edit",
          function() {
            var e = $(this).attr("data-id");
            pm.envManager.showEditor(e)
          }),
        $("#environments-list").on("click", ".environment-action-download",
          function() {
            var e = $(this).attr("data-id");
            pm.envManager.downloadEnvironment(e)
          }),
        $(".environment-action-back").on("click",
          function() {
            pm.envManager.showSelector()
          }),
        $("#environment-selector").on("click", ".environment-list-item",
          function() {
            var e = $(this).attr("data-id"),
        ...
        $("#environment-selector").on("click", ".environment-list-item-noenvironment",
          function() {
        ...
        $("#environment-quicklook").on("mouseenter",
          function() {
            $("#environment-quicklook-content").css("display", "block")
          }),
        $("#environment-quicklook").on("mouseleave",
          function() {
            $("#environment-quicklook-content").css("display", "none")
          }),
        $("#environment-files-input").on("change",
          function(e) {
            var t = e.target.files;
            pm.envManager.importEnvironments(t),
              $("#environment-files-input").val("")
          }),
        $(".environments-actions-add").on("click",
          function() {
            pm.envManager.showEditor()
          }),
        $(".environments-actions-import").on("click",
          function() {
            pm.envManager.showImporter()
          }),
        $(".environments-actions-manage-globals").on("click",
          function() {
            pm.envManager.showGlobals()
          }),
        $(".environments-actions-add-submit").on("click",
          function() {
        ...
        $(".environments-actions-add-back").on("click",
          function() {
        ...
        $("#environments-list-help-toggle").on("click",
          function() {
    ...
    processString: function(e, t) {
      ...
      for (var f = 0; f < n; f++) i = u + t[f].key + a,
        s = new RegExp(i, "g"),
        r = r.replace(i, t[f].value);
      var l = pm.envManager.globals;
      n = l.length;
      for (f = 0; f < n; f++) i = u + l[f].key + a,
        s = new RegExp(i, "g"),
    ...
    addEnvironment: function() {
      ...
      pm.indexedDB.environments.addEnvironment(n,
        function() {
    ...
    updateEnvironment: function() {
      ...
      pm.indexedDB.environments.updateEnvironment(r,
        function() {
          pm.envManager.getAllEnvironments(),
            pm.envManager.showSelector()
        })
    ...
    deleteEnvironment: function(e) {
      pm.indexedDB.environments.deleteEnvironment(e,
        function() {
          pm.envManager.getAllEnvironments(),
            pm.envManager.showSelector()
        })
  ...
  pm.filesystem = {
    ...
    renderResponsePreview: function(e, t, n, r) {
      e = encodeURI(e),
        e = e.replace("/", "_"),
        pm.filesystem.removeFileIfExists(e,
          function() {
            pm.filesystem.fs.root.getFile(e, {
                create: !0
              },
              ...
              function(e) {
                e.createWriter(function(i) {
                    i.onwriteend = function(t) {
                      ...
                      typeof chrome != "undefined" && chrome.tabs.create(n,
                        function(e) {}),
                        r()
                    },
                      i.onerror = function(e) {
  ...
  pm.helpers = {
    init: function() {
      $("#request-types .request-helper-tabs li").on("click",
        function() {
        ...
        $(".request-helper-submit").on("click",
          function() {
    ...
    oAuth1: {
      ...
      generateSignature: function() {
        if ($("#url").val() === "") return $("#request-helpers").css("display", "block"),
        ...
        var u = {};
        return $('input[key="oauth_consumer_secret"]').val() != "" && (u.consumerSecret = $('input[key="oauth_consumer_secret"]').val(), u.consumerSecret = pm.envManager.convertString(u.consumerSecret)),
        $('input[key="oauth_token_secret"]').val() != "" && (u.tokenSecret = $('input[key="oauth_token_secret"]').val(), u.tokenSecret = pm.envManager.convertString(u.tokenSecret)),
      ...
      process: function() {
        ...
        for (var i = 0,
               s = e.length; i < s; i++) e[i].value = pm.envManager.convertString(e[i].value);
        ...
        if (u) {
          ...
          h = h.substring(0, h.length - 1),
            ...
            pm.request.openHeaderEditor()
        } else if (pm.request.method === "GET") $("#url-keyvaleditor").keyvalueeditor("reset", e),
  ...
  pm.history = {
    ...
    deleteRequest: function(e) {
      pm.indexedDB.deleteRequest(e,
        function(e) {
          var t = pm.history.requests,
            n = -1,
            r = t.length;
          for (var i = 0; i < r; i++) if (t[i].id === e) {
            n = i;
            break
          }
          n >= 0 && t.splice(n, 1),
  ...
  pm.indexedDB = {
    ...
    open_v21: function() {
      ...
      e.onsuccess = function(e) {
        ...
        } else pm.history.getAllRequests(),
          pm.envManager.getAllEnvironments()
      },
    ...
    init: function() {
      ...
      $("body").on("keydown", "input",
        ...
        $(document).bind("keydown", "p",
          function() {
            if (pm.request.isMethodWithBody(pm.request.method)) return $("#formdata-keyvaleditor div:first-child input:first-child").focus(),
              !1
          }),
  ...
  pm.layout = {
    ...
    init: function() {
      $("#sidebar-footer").on("click",
        ...
        $("#update-request-in-mongoDB").on("click",
          function() {
            alert("wwwwwwwwwwwwwwwwwwwwwww"+pm.request);
          }),
        $("#update-request-in-collection").on("click",
          function() {
            pm.collections.updateCollectionFromCurrentRequest()
          }),
        $("#cancel-request").on("click",
          function() {
            pm.request.cancel()
          }),
        $("#request-actions-reset").on("click",
          function() {
            pm.request.startNew()
          }),
              ...
              e.name = t,
                ...
                pm.indexedDB.updateCollectionRequest(e,
                  function(t) {
                    ...
                    pm.request.collectionRequestId === e.id && ($("#request-name").html(e.name), $("#request-description").html(e.description)),
        ...
        $("#request-meta").on("mouseenter",
          function() {
            $(".request-meta-actions").css("display", "block")
          }),
        $("#request-meta").on("mouseleave",
          function() {
    ...
    attachSocialButtons: function() {
      var e = $("#about-postman-twitter-button").html(); (e === "" || !e) && $("#about-postman-twitter-button").html(this.socialButtons.twitter),
    ...
    sidebar: {
      ...
      init: function() {
        $("#history-items").on("click", ".request-actions-delete",
          function() {
            var e = $(this).attr("data-request-id");
            pm.history.deleteRequest(e)
          }),
          $("#history-items").on("click", ".request",
            function() {
              var e = $(this).attr("data-request-id");
      ...
      addRequestListeners: function() {
        $("#sidebar-sections").on("mouseenter", ".sidebar-request",
          function() {
            var e = jQuery(".request-actions", this);
            e.css("display", "block")
          }),
          $("#sidebar-sections").on("mouseleave", ".sidebar-request",
            function() {
              var e = jQuery(".request-actions", this);
              e.css("display", "none")
            })
  ...
  pm.request = {
    ...
    body: {
      ...
      initEditorListeners: function() {
        $("#body-editor-mode-selector .dropdown-menu").on("click", "a",
          function(e) {
    ...
    init: function() {
      this.url = "",
        ...
        this.method = "GET",
        this.dataMode = "params",
      this.areListenersAdded || (this.areListenersAdded = !0, this.initializeHeaderEditor(), this.initializeUrlEditor(), this.body.init(), this.addListeners());
    ...
    initializeHeaderEditor: function() {
      ...
      $("#headers-keyvaleditor").keyvalueeditor("init", e),
        $("#headers-keyvaleditor-actions-close").on("click",
          function() {
            pm.request.closeHeaderEditor()
          }),
        $("#headers-keyvaleditor-actions-open").on("click",
          function() {
            pm.request.openHeaderEditor()
          })
    },
    ...
    initializeUrlEditor: function() {
      ...
      $(e).keyvalueeditor("init", t),
        $("#url-keyvaleditor-actions-close").on("click",
          function() {
            pm.request.closeUrlEditor()
          }),
        $("#url-keyvaleditor-actions-open").on("click",
          function() {
    ...
    addListeners: function() {
      $("#data-mode-selector").on("click", "a",
        function() {
          var e = $(this).attr("data-mode");
          pm.request.body.setDataMode(e)
        }),
        $(".request-meta-actions-togglesize").on("click",
          function() {
    ...
    response: {
      ...
      loadHeaders: function(e) {
        this.headers = pm.request.unpackResponseHeaders(e),
          ...
          this.headers = _.sortBy(this.headers,
            function(e) {
              return e.name
            }),
      ...
      load: function(e) {
        if (e.readyState == 4) {
          ...
          if (!_.isUndefined(s) && !_.isNull(s)) {
            ...
            if (s.search(/image/i) >= 0) {
            ...
            } else if (s.search(/pdf/i) >= 0 && e.responseType == "arraybuffer") u = "pdf",
              $("#response-as-code").css("display", "none"),
              $("#response-as-text").css("display", "none"),
              ...
              $("#response-pretty-modifiers").css("display", "none"),
              pm.filesystem.renderResponsePreview("response.pdf", r, "pdf",
                function(e) {
          ...
          u === "html" && ($("#response-as-preview").html(""), pm.filesystem.renderResponsePreview("response.html", pm.request.response.text, "html",
            function(e) {
      ...
      loadCookies: function(e) {
        chrome.cookies.getAll({
          ...
          function(e) {
            var t;
            e ? t = e.length: t = 0;
            if (t == 0) $("#response-tabs-cookies").html("Cookies"),
      ...
      setFormat: function(e, t, n, r) {
        ...
        var a;
        pm.settings.get("lineWrapping") === !0 ? ($("#response-body-line-wrapping").addClass("active"), a = !0) : ($("#response-body-line-wrapping").removeClass("active"), a = !1),
          pm.editor.mode = o;
        var f = o;
        ...
        if (!pm.editor.codeMirror || r) {
          ...
          l.setValue(t)
        } else pm.editor.codeMirror.setOption("onGutterClick", s),
          ...
          $(window).scrollTop(0);
        if (n === "parsed") $("#response-as-code").css("display", "block"),
          $("#response-as-text").css("display", "none"),
          $("#response-as-preview").css("display", "none"),
      ...
      openInNewWindow: function(e) {
        var t = "response.html",
          n = "text/html";
        pm.filesystem.saveAndOpenFile(t, e, n,
          function() {})
      }
    },
    startNew: function() {
    ...
    refreshLayout: function() {
      ...
      this.name !== "" ? ($("#request-meta").css("display", "block"), $("#request-name").css("display", "inline-block"), $("#request-description").css("display") === "block" ? $("#request-description").css("display", "block") : $("#request-description").css("display", "none")) : ($("#request-meta").css("display", "none"), $("#request-name").css("display", "none"), $("#request-description").css("display", "none")),
    ...
    loadRequestInEditor: function(e, t) {
      pm.helpers.showRequestHelper("normal"),
        ...
        typeof e.name != "undefined" ? (this.name = e.name, $("#request-meta").css("display", "block"), $("#request-name").html(this.name), $("#request-name").css("display", "inline-block")) : (this.name = "", $("#request-meta").css("display", "none"), $("#request-name").css("display", "none")),
        typeof e.description != "undefined" ? (this.description = e.description, $("#request-description").html(this.description), $("#request-description").css("display", "block")) : (this.description = "", $("#request-description").css("display", "none")),
      ...
      $("#url-keyvaleditor").keyvalueeditor("reset", n),
        ...
        this.response.clear(),
        $("#request-method-selector").val(this.method),
        this.isMethodWithBody(this.method) ? (this.dataMode = e.dataMode, $("#data").css("display", "block"), pm.request.body.loadData(e.dataMode, e.data)) : $("#data").css("display", "none");
      var r = pm.request.getHeaderValue("Content-Type"),
        i,
        s;
      r === !1 ? (i = "text", s = "text") : r.search(/json/i) !== -1 || r.search(/javascript/i) !== -1 ? (i = "javascript", s = "json") : r.search(/xml/i) !== -1 ? (i = "xml", s = "xml") : r.search(/html/i) !== -1 ? (i = "xml", s = "html") : (s = "text", r = "text"),
    ...
    send: function(e) {
      ...
      if (this.isMethodWithBody(a)) {
        if (this.dataMode === "raw") f = i.processString(f, o),
          c = f,
          r.send(c);
